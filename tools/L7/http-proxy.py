...
def flood(target: str) -> None:
    ...
    try:
        ...
        response = requests.get(target, headers=headers, proxies=proxy, timeout=1)
        ...
        payload_size = f"{F.RESET} Requested Data Size: {F.CYAN}{round(len(response.content)/1024, 2):>6} MB"
